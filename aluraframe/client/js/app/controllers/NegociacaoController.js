...
System.register(['../models/ListaNegociacoes', '../views/NegociacoesView', '../views/MensagemView', '../services/NegociacaoService', '../helpers/DateHelper', '../helpers/Bind', '../models/Negociacao'], function (_export, _context) {
    "use strict";

    var ListaNegociacoes, NegociacoesView, MensagemView, NegociacaoService, DateHelper, Bind, Negociacao, _createClass, NegociacaoController, negociacaoController;
        ...
        execute: function () {
            ...
            NegociacaoController = function () {
                function NegociacaoController() {
                    ...
                    this._mensagem = new Bind(new MensagemView(), new MensagemView($("#mensagemView")), 'texto');
